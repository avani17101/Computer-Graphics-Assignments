...
void display() {
   ...
   glBegin(GL_QUADS);               
        ...
        //sides of undecagonal pyramid
        glColor3f(0.6f, 0.1f, 0.3f );
        glVertex3f(-a*sin(81.9*pi/180) ,0.0f, a*cos(81.9*pi/180)); 

        glColor3f(0.6f, 0.1f, 0.3f );
        glVertex3f(-a*sin(49.2*pi/180) ,0.0f, a*cos(49.2*pi/180)); 
        ...
        glColor3f(1.0f, 0.4f, 0.8f );
        glVertex3f(-a*sin(16.4*pi/180) ,0.0f, a*cos(16.4*pi/180)); 
