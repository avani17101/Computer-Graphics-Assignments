...
namespace glm
{
	...
	/// Generate a random 3D vector which coordinates are regulary distributed within the volume of a player of a given radius
	/// 
	/// @param Radius
	/// @see gtc_random
	template <typename T>
	GLM_FUNC_DECL tvec3<T, defaultp> playerRand(
		T Radius);
